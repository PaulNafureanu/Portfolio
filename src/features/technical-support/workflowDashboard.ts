...
export const workflowStages: WorkflowStage[] = [
  {
    ...
    description: "Understand what the user says is broken or blocked.",
  },
  {
    key: "ticket-priority",
    label: "Ticket + priority",
    description: "Classify the issue and decide urgency based on impact.",
  },
  {
    key: "information-needed",
    label: "Information needed",
    description: "Collect identifiers, timestamps, screenshots, and scope.",
  },
  {
    key: "investigation",
    label: "Investigation",
    description: "Check likely causes before escalating.",
  },
  {
    key: "customer-update",
    label: "Customer update",
    description: "Reply clearly and ask only for useful missing details.",
  },
  {
    key: "internal-note",
    label: "Internal note",
    description: "Document what was checked and what is still unknown.",
  },
  {
    key: "outcome",
    label: "Escalation / resolution",
    description: "Resolve or escalate with useful context.",
  },
];
...
export const workflowCases: WorkflowCase[] = [
  {
    ...
    issueClass: "Billing issue",
    type: "Billing / Application Support",
    priority: "High",
    tools: ["Jira", "Postman"],
    shortDescription: "Customer paid, but account access remains blocked.",
    summary:
    ...
    stageDetails: {
      ...
      "customer-update": {
        ...
        content:
          "Hi, thanks for reporting this. Could you please confirm the account email, invoice/payment reference, approximate payment time, and payment method?",
      },
      "internal-note": {
  ...
  },
  {
    ...
    shortDescription:
      "Customer cannot log in because the page returns a server error.",
    summary:
    ...
    stageDetails: {
      ...
      "customer-update": {
        ...
        content:
          "Hi, thanks for reporting this. Could you please send the email address used for login, the exact error message or screenshot, browser/device, and approximate time?",
      },
      "internal-note": {
  ...
  },
  {
    ...
    priority: "Medium",
    tools: ["Jira", "Confluence"],
    shortDescription: "Customer cannot receive the password reset email.",
    summary:
  ...
  },
  {
    ...
    tools: ["Postman", "Jira"],
    shortDescription:
      "Customer integration stopped working with 401 Unauthorized.",
    summary:
